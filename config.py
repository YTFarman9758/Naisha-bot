...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "@yt_farman")
# --------------------------------------------------------
...
YT_API_KEY = getenv("YT_API_KEY" , 'ShrutiBotsCMJel4aMwKOc8ZHhkWHr') ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/NKD-BOT/Naishabot",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+LfMoLOc65BkyOThl")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
